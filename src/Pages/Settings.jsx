  ...
  const Row = ({ label, desc, action, noBorder }) => (
    ...
    >
      <div>
        ...
        {desc && (
          <p style={{ fontFamily: "Poppins", fontSize: 12, color: muted }}>
            {desc}
          </p>
        )}
      </div>
    ...
    >
      ...
      <Section title="Appearance">
        ...
        <div style={{ padding: "20px 20px" }}>
          ...
          >
            Changes the highlight color across the entire app
          </p>
            ...
            <button
              onClick={() => {
                if (window.confirm("Clear all bookmarks?"))
                  bookmarks.items.forEach((s) => bookmarks.remove(s.id));
              }}
              style={{
                background: "none",
                border: `1px solid ${border}`,
            ...
            <button
              onClick={() => {
                if (window.confirm("Clear all favourites?"))
                  favourites.items.forEach((s) => favourites.remove(s.id));
              }}
              style={{
                background: "none",
                border: `1px solid ${border}`,
