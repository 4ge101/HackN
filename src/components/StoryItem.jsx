...
export default function StoryItem({ story, rank }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 12, color: '#999', textAlign: 'right', paddingTop: 2 }}>
        {rank}.
      </div>
      <div>
        ...
        <div style={{ fontSize: 12, color: '#666', display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          <span style={{ color: '#FF6600', fontWeight: 500 }}>▲ {story.score ?? 0}</span>
          <span>·</span>
          <span
